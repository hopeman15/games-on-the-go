...
java {
    /*
     * Since this is a Gradle plugin, we need to use the Java version that Gradle is using,
     * which will differ from the Java version we're using in our application.
     */
